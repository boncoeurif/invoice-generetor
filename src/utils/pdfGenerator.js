...
export const generateInvoicePDF = (invoice, t) => {
  try {
    ...
    doc.setFontSize(10);
    doc.text("Bank Name: Your Bank Name", 15, finalY + 7);
    doc.text("Account No: XXXX-XXXX-XXXX", 15, finalY + 13);
    doc.text("Payment Status: PAID", 15, finalY + 19);
    ...
    doc.text("Authorized Signature", 145, 265);

    // Footer
    doc.setFontSize(9);
    doc.setTextColor(150, 150, 150);
    doc.text("Thank you for your business. Please contact us if you have any questions.", 105, 280, { align: "center" });
